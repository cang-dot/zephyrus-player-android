export default {
  ...
  about: {
    ...
    gotoGithub: 'Githubへ',
    website: '公式サイト',
    websiteDesc: 'Zephyrus Player の紹介、ダウンロード、ドキュメントを表示します',
    visitWebsite: 'サイトを開く',
    author: '作者',
  ...
  onboarding: {
    ...
    continue: '続ける',
    startSetup: '設定を始める',
    startExperience: '再生を始める',
    welcomeTitle: 'Zephyrus へようこそ',
    welcomeSubtitle: '1 分ほどでプレイヤーの初期設定が完了します',
    featureSearch: 'マルチプラットフォーム検索、タップして再生',
    featureStyles: '9 種類のプレイヤースタイルと逐字歌詞',
    featureLocal: 'ローカル音楽の取り込みに対応',
    languageTitle: '言語を選択',
    languageDesc: '設定でいつでも変更できます',
    themeTitle: '外観を選択',
    themeDesc: 'ダーク、ライト、またはシステムに従う',
    themeAuto: 'システムに従う',
    themeLight: 'ライト',
    themeDark: 'ダーク',
    folderTitle: 'ローカル音楽を取り込む',
    folderDesc: '音楽の保存フォルダを選ぶと自動でスキャンします',
    folderPick: 'フォルダを選択',
    folderPickMore: '別のフォルダを追加',
    folderPicking: '選択待ち…',
    folderDone: '{n} 件のフォルダを追加しました',
    lyricTitle: 'ステータスバー歌詞',
    lyricDesc: '他のアプリの上に現在の歌詞を浮かべて表示します',
    lyricEnable: '有効にして許可',
    lyricGranted: 'ステータスバー歌詞が有効になりました',
    lyricNotGranted: '未許可です。後から設定で有効化できます',
    lyricRetry: '再試行',
    accountTitle: 'アカウントにログイン',
    accountDesc:
      'NetEase Cloud Music や QQ 音楽などにログインして、プレイリストやお気に入りを利用できます',
    accountDone: 'ログインしました。「マイページ」でいつでも管理できます',
    searchTitle: '好きな曲を検索',
    searchDesc:
      '結果をタップして再生すると、プレイヤーがカバーから配色を取得します。その後、設定パネルでプレイヤースタイルを選べます',
    searchPlaceholder: '曲名またはアーティスト名',
    searchExample1: '晴天',
    searchExample2: '告白气球',
    searchExample3: '孤勇者',
    searchClear: 'クリア',
    searchRetry: '再試行',
    searchEmpty: '関連する曲が見つかりません',
    searchError: '検索に失敗しました。ネットワークを確認してください',
    stylePickTitle: 'プレイヤースタイルを選ぶ',
    stylePickDesc:
      '上にリアルタイムプレビュー — スタイルをタップすると即時切り替わり、細部も調整できます',
    stylePickHint: 'ヒント：逐字歌詞は再生中が一番美しく表示されます',
    changeSong: '別の曲を試す',
    errorConfirmHint:
  ...
  lyricSettings: {
    ...
    centerDisplay: '中央表示',
    alignment: '歌詞の配置',
    alignmentDescription: 'スクロール歌詞の水平方向の配置を調整します',
    alignmentLeft: '左揃え',
    alignmentCenter: '中央揃え',
    alignmentRight: '右揃え',
    showTranslation: '翻訳を表示',
    showTranslationDescription: '歌詞の下に翻訳を表示します',
    scrollFont: 'スクロール歌詞フォント',
    scrollFontDescription: '全画面スクロール歌詞にのみ適用されます',
    scrollFontDefault: 'デフォルト',
    scrollFontWeight: 'スクロール歌詞の太さ',
    scrollFontSize: 'スクロール歌詞のサイズ',
    scrollFontSizeAuto: 'デフォルト',
    ...
    statusBarLyricOptions: {
      enable: 'フローティング歌詞を有効化',
      enableDesc: 'ほかのアプリの上に表示',
      portrait: '縦向き',
      landscape: '横向き',
      wordByWord: '単語ごとに表示',
      wordByWordDesc: 'オフの場合は行全体を未再生色で表示します',
      capsuleWidth: 'カプセル幅',
      capsuleWidthDesc: '歌詞に合わせるか、固定幅の中でスクロールします',
      widthFit: '歌詞に合わせる',
      widthFixed: '固定スクロール',
      fixedWidth: '固定幅',
      font: 'フォント',
      fontDesc: 'システム、TTF、OTF に対応',
      systemFont: 'システムフォント',
      importedFont: '読み込み済みフォント',
      fontSize: 'サイズ',
      fontWeight: '太さ',
      importFont: 'TTF/OTFを読み込む',
      sung: '再生済み',
      current: '現在の単語',
      upcoming: '未再生',
      surfaceFill: '背景色',
      ...
      custom: 'カスタム',
      opacity: '背景の透明度',
      permissionHint: '他のアプリの上に表示する権限を許可してください',
      installed: 'インストール済み',
      installFailed: 'フォントのインストールに失敗しました'
    },
    hideLyrics: '歌詞を非表示',
    hidePlayBar: '再生バーを非表示',
    hideMiniPlayBar: 'ミニ再生バーを非表示',
    alwaysShowPlayerControls: '再生コントロールを常に表示',
  ...
  keepAlive: {
    ...
    audioFocusDesc:
      'メディアフォーカスを維持しダッキングを防ぎます。通話や高優先度のシステム音声では一時停止します',
