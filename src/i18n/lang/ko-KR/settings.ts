export default {
  ...
  about: {
    ...
    website: '공식 웹사이트',
    websiteDesc: 'Zephyrus Player 소개, 다운로드 및 문서를 확인합니다',
  ...
  onboarding: {
    ...
    continue: '계속',
    startSetup: '설정 시작',
    startExperience: '바로 시작하기',
    welcomeTitle: 'Zephyrus에 오신 것을 환영합니다',
    welcomeSubtitle: '1분이면 플레이어 설정을 끝낼 수 있어요',
    featureSearch: '멀티 플랫폼 검색, 탭해서 바로 재생',
    featureStyles: '9가지 플레이어 스타일과 글자 단위 가사',
    featureLocal: '로컬 음악 가져오기 지원',
    languageTitle: '언어 선택',
    languageDesc: '설정에서 언제든 변경할 수 있어요',
    themeTitle: '테마 선택',
    themeDesc: '다크, 라이트 또는 시스템 따라가기',
    themeAuto: '시스템 따라가기',
    themeLight: '라이트',
    themeDark: '다크',
    folderTitle: '로컬 음악 가져오기',
    folderDesc: '음악이 있는 폴더를 선택하면 자동으로 스캔합니다',
    folderPick: '폴더 선택',
    folderPickMore: '폴더 더 추가',
    folderPicking: '선택 대기 중…',
    folderDone: '폴더 {n}개 추가됨',
    lyricTitle: '상태 표시줄 가사',
    lyricDesc: '다른 앱 위에 현재 재생 중인 가사를 표시합니다',
    lyricEnable: '켜고 권한 허용',
    lyricGranted: '상태 표시줄 가사가 켜졌어요',
    lyricNotGranted: '권한이 없어요. 나중에 설정에서 켤 수 있어요',
    lyricRetry: '다시 시도',
    accountTitle: '계정 로그인',
    accountDesc: '네이버 뮤직, QQ 음악 등에 로그인해서 플레이리스트와 좋아요를 사용하세요',
    accountDone: '로그인 완료! 내 페이지에서 언제든 관리할 수 있어요',
    searchTitle: '좋아하는 노래를 검색해 보세요',
    searchDesc:
      '결과를 탭해서 재생하면 플레이어가 커버 색상을 가져옵니다. 이후 설정 패널에서 플레이어 스타일을 고를 수 있어요',
    searchPlaceholder: '노래 제목 또는 가수 이름',
    searchExample1: '晴天',
    searchExample2: '告白气球',
    searchExample3: '孤勇者',
    searchClear: '지우기',
    searchRetry: '다시 시도',
    searchEmpty: '관련 노래를 찾을 수 없어요',
    searchError: '검색에 실패했어요. 네트워크를 확인해 주세요',
    stylePickTitle: '플레이어 스타일 선택',
    stylePickDesc: '위에서 실시간 미리보기 — 스타일을 탭하면 즉시 전환되고 세부 설정도 가능해요',
    stylePickHint: '팁: 글자 단위 가사는 재생 중일 때 가장 아름다워요',
    changeSong: '다른 곡 시도하기',
    errorConfirmHint:
  ...
  lyricSettings: {
    ...
    centerDisplay: '중앙 표시',
    alignment: '가사 정렬',
    alignmentDescription: '스크롤 가사의 가로 정렬 방식을 조정합니다',
    alignmentLeft: '왼쪽 정렬',
    alignmentCenter: '가운데 정렬',
    alignmentRight: '오른쪽 정렬',
    showTranslation: '번역 표시',
    showTranslationDescription: '가사 아래에 번역을 표시합니다',
    scrollFont: '스크롤 가사 글꼴',
    scrollFontDescription: '전체 화면 스크롤 가사에만 적용됩니다',
    scrollFontDefault: '기본',
    scrollFontWeight: '스크롤 가사 굵기',
    scrollFontSize: '스크롤 가사 크기',
    scrollFontSizeAuto: '기본',
    ...
    statusBarLyricOptions: {
      enable: '플로팅 가사 사용',
      enableDesc: '다른 앱 위에 표시',
      portrait: '세로',
      landscape: '가로',
      wordByWord: '단어별 표시',
      wordByWordDesc: '끄면 전체 문장에 미재생 색상을 사용합니다',
      capsuleWidth: '캡슐 너비',
      capsuleWidthDesc: '가사 길이에 맞추거나 고정 너비에서 스크롤합니다',
      widthFit: '가사에 맞춤',
      widthFixed: '고정 스크롤',
      fixedWidth: '고정 너비',
      font: '글꼴',
      fontDesc: '시스템, TTF 및 OTF 글꼴 지원',
      systemFont: '시스템 글꼴',
      importedFont: '가져온 글꼴',
      fontSize: '크기',
      fontWeight: '굵기',
      importFont: 'TTF/OTF 가져오기',
      sung: '재생됨',
      current: '현재 단어',
      upcoming: '재생 전',
      surfaceFill: '표면 채우기',
      surfaceBorder: '표면 테두리',
      theme: '곡 테마 색상',
      custom: '사용자 지정',
      opacity: '배경 투명도',
      permissionHint: '다른 앱 위에 표시 권한을 허용하세요',
      installed: '설치됨',
      installFailed: '글꼴 설치 실패'
    },
    hideLyrics: '가사 숨기기',
    hidePlayBar: '재생바 숨기기',
    hideMiniPlayBar: '미니 재생바 숨기기',
    alwaysShowPlayerControls: '재생 컨트롤 항상 표시',
  ...
  keepAlive: {
    ...
    audioFocus: '백그라운드 유지',
    audioFocusDesc:
      '미디어 포커스를 유지하고 덕킹을 방지합니다. 통화와 우선순위가 높은 시스템 오디오는 일시 정지됩니다',
