export default {
  ...
  styleCustomization: {
    ...
    presetNone: 'None',
    presetAurora: 'Aurora',
    auroraSpeedLabel: 'Aurora speed',
    auroraPosition: 'Aurora position',
    posTop: 'Top',
    ...
    smokeFollowThemeColor: 'Follow Song Color for Smoke',
    smokeCustomColor: 'Custom Smoke Color',
    smokeGlowFollowThemeColor: 'Follow Song Color for Climax Glow',
    smokeGlowCustomColor: 'Custom Climax Glow Color',
