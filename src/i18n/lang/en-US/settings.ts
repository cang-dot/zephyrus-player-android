export default {
  ...
  about: {
    ...
    websiteDesc: 'View the Zephyrus Player overview, downloads, and documentation',
    visitWebsite: 'Open Website',
    author: 'Author',
    authorDesc: 'Original: algerkong　Modified by: cang-dot',
    messages: {
  ...
  onboarding: {
    ...
    startExperience: 'Start listening',
    welcomeTitle: 'Welcome to Zephyrus',
    welcomeSubtitle: 'Set up your player in about a minute',
    featureSearch: 'Multi-platform search, tap to play',
    featureStyles: '9 player styles and word-by-word lyrics',
    featureLocal: 'Import your local music',
    ...
    themeLight: 'Light',
    themeDark: 'Dark',
    folderTitle: 'Import local music',
    folderDesc: 'Pick a folder where your music lives and it will be scanned automatically',
    folderPick: 'Choose folder',
    folderPickMore: 'Add another folder',
    folderPicking: 'Waiting for selection…',
    folderDone: '{n} folder(s) added',
    lyricTitle: 'Status bar lyrics',
    lyricDesc: 'Show the current lyric above other apps in a floating overlay',
    lyricEnable: 'Enable and grant',
    lyricGranted: 'Status bar lyrics enabled',
    lyricNotGranted: 'Not granted yet. You can enable it later in Settings',
    lyricRetry: 'Try again',
    accountTitle: 'Sign in to your account',
    accountDesc: 'Sign in to NetEase Cloud Music, QQ Music and more to use your playlists',
    accountDone: 'Signed in. Manage your accounts anytime from the Library page',
    searchTitle: 'Search a song you love',
    searchDesc:
      'Play a result and the player picks up colors from the cover. Then pick a player style in the settings panel',
    searchPlaceholder: 'Song or artist name',
    searchExample1: '晴天',
    searchExample2: '告白气球',
    searchExample3: '孤勇者',
    searchClear: 'Clear',
    searchRetry: 'Retry',
    searchEmpty: 'No songs found',
    searchError: 'Search failed. Check your network',
    stylePickTitle: 'Pick your player style',
    stylePickDesc:
      'Live preview above — tap a style to switch instantly, then fine-tune the details',
    stylePickHint: 'Tip: word-by-word lyrics look best while playing',
    changeSong: 'Try another song',
    errorConfirmHint:
  ...
  lyricSettings: {
    ...
    alignmentDescription: 'Adjust the horizontal alignment of scrolling lyrics',
    alignmentLeft: 'Align Left',
    alignmentCenter: 'Align Center',
    alignmentRight: 'Align Right',
    showTranslation: 'Show Translation',
    showTranslationDescription: 'Show translated text below lyrics',
    scrollFont: 'Scrolling Lyric Font',
    scrollFontDescription: 'Applies only to the fullscreen scrolling lyrics view',
    scrollFontDefault: 'Default',
    scrollFontWeight: 'Scrolling Lyric Weight',
    scrollFontSize: 'Scrolling Lyric Size',
    scrollFontSizeAuto: 'Default',
    ...
    statusBarLyricOptions: {
      enable: 'Enable overlay lyrics',
      enableDesc: 'Show above other apps',
      portrait: 'Portrait',
      landscape: 'Landscape',
      wordByWord: 'Word by word',
      wordByWordDesc: 'Use the upcoming color for the whole line when disabled',
      capsuleWidth: 'Capsule width',
      capsuleWidthDesc: 'Follow lyric length or scroll inside a fixed width',
      widthFit: 'Fit lyric',
      widthFixed: 'Fixed scroll',
      fixedWidth: 'Fixed width',
      font: 'Font',
      fontDesc: 'The native overlay supports system, TTF and OTF fonts',
      systemFont: 'System font',
      importedFont: 'Imported font',
      fontSize: 'Size',
      fontWeight: 'Weight',
      importFont: 'Import TTF/OTF',
      sung: 'Sung',
      ...
      permissionHint: 'Allow Zephyrus to display over other apps',
      installed: 'Installed',
      installFailed: 'Font installation failed'
    },
    hideLyrics: 'Hide Lyrics',
    hidePlayBar: 'Hide Play Bar',
    hideMiniPlayBar: 'Hide Mini Play Bar',
    alwaysShowPlayerControls: 'Always show player controls',
  ...
  keepAlive: {
    ...
    audioFocusDesc:
      'Hold media focus and ignore duckable attenuation; calls and higher-priority system audio still pause playback',
