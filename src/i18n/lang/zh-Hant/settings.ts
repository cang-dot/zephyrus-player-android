export default {
  ...
  onboarding: {
    ...
    continue: '繼續',
    startSetup: '開始設定',
    startExperience: '直接開始體驗',
    welcomeTitle: '歡迎使用 Zephyrus',
    welcomeSubtitle: '只需一分鐘，完成專屬你的播放器設定',
    featureSearch: '多平台搜尋，點擊即聽',
    featureStyles: '9 種播放器樣式與逐字歌詞',
    featureLocal: '支援匯入本機音樂',
    languageTitle: '選擇語言',
    languageDesc: '可隨時在設定中更改',
    themeTitle: '選擇外觀',
    themeDesc: '深色、淺色，或跟隨系統',
    themeAuto: '跟隨系統',
    themeLight: '淺色',
    themeDark: '深色',
    folderTitle: '匯入本機音樂',
    folderDesc: '選擇存放音樂的資料夾，自動掃描本機歌曲',
    folderPick: '選擇資料夾',
    folderPickMore: '再選一個資料夾',
    folderPicking: '等待選擇…',
    folderDone: '已加入 {n} 個資料夾',
    lyricTitle: '狀態列歌詞',
    lyricDesc: '在其他應用程式上方懸浮顯示目前播放歌詞',
    lyricEnable: '開啟並授權',
    lyricGranted: '已開啟狀態列歌詞',
    lyricNotGranted: '未完成授權，可稍後在設定中開啟',
    lyricRetry: '重新授權',
    accountTitle: '登入音樂帳號',
    accountDesc: '登入網易雲、QQ 音樂等帳號，使用你的歌單與收藏',
    accountDone: '登入成功，可隨時在「我的」頁管理帳號',
    searchTitle: '搜尋一首你喜歡的歌',
    searchDesc: '點擊播放搜尋結果，播放器會根據封面取色，隨後即可在設定面板挑選播放器樣式',
    ...
    searchClear: '清空',
    searchRetry: '重試',
    searchEmpty: '沒有找到相關歌曲',
    searchError: '搜尋失敗，請檢查網路',
    stylePickTitle: '挑選你的播放器樣式',
    stylePickDesc: '上方即時預覽播放器效果，點擊樣式立即切換，可繼續自訂細節',
    stylePickHint: '提示：滾動歌詞逐字跟隨，效果在播放時最佳',
    changeSong: '換首歌試試',
  ...
  lyricSettings: {
    ...
    scrollFont: '滾動歌詞字體',
    scrollFontDescription: '僅作用於全螢幕滾動歌詞頁',
    scrollFontDefault: '預設',
    scrollFontWeight: '滾動歌詞字重',
    scrollFontSize: '滾動歌詞大小',
    scrollFontSizeAuto: '預設',
