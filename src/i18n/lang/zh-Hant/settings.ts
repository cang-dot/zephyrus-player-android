export default {
  ...
  playback: {
    ...
    platforms: {
      title: '平台帳號',
      desc: '管理各音樂平台的登入狀態，登入後可解鎖高品質音源和獨佔內容',
      loggedIn: '已登入',
      notLoggedIn: '未登入',
      ...
      loggingIn: '登入中...',
      logoutSuccess: '已登出',
      loginSuccess: '{platform} 登入成功',
      loginWindowFailed: '無法開啟登入視窗',
      manualCookie: '手動輸入 Cookie',
      cookiePlaceholder: '貼上 Cookie 字串，例如：uin=12345; qm_keyst=abc;',
      saveCookie: '儲存 Cookie',
      cookieSaved: 'Cookie 已儲存',
      qq: { desc: '需要 uin 和 qm_keyst Cookie 才能解鎖高品質音源' },
      migu: { desc: 'aversionid Cookie 可解鎖更高品質' },
      joox: { desc: '需要 wmid 和 session_key Cookie' },
      kugou: { desc: '無需登入，可直接搜尋' },
      kuwo: { desc: '無需登入，可直接搜尋' }
    }
  },
  application: {
    closeAction: '關閉行為',
  ...
  about: {
    ...
    website: '官方網站',
    websiteDesc: '查看 Zephyrus Player 產品介紹、下載與文件',
    visitWebsite: '開啟官網',
    author: '作者',
  ...
  lyricSettings: {
    ...
    centerDisplay: '置中顯示',
    alignment: '歌詞對齊',
    alignmentDescription: '調整滾動歌詞的水平對齊方式',
    alignmentLeft: '靠左對齊',
    alignmentCenter: '置中對齊',
    alignmentRight: '靠右對齊',
    ...
    statusBarLyricOptions: {
      enable: '啟用懸浮歌詞',
      enableDesc: '顯示在其他應用程式上層',
      portrait: '直向',
      landscape: '橫向',
      wordByWord: '逐字顯示',
      wordByWordDesc: '關閉時整句使用未唱文字色',
      capsuleWidth: '膠囊寬度',
      capsuleWidthDesc: '跟隨歌詞長度，或固定寬度捲動顯示',
      widthFit: '跟隨歌詞',
      widthFixed: '固定捲動',
      fixedWidth: '固定寬度',
      font: '字型',
      fontDesc: '懸浮窗僅支援系統、TTF 與 OTF',
      systemFont: '系統字型',
      importedFont: '已匯入字型',
      fontSize: '字號',
      fontWeight: '字重',
      importFont: '匯入 TTF/OTF',
      sung: '已唱歌詞',
      current: '目前分詞',
      upcoming: '未唱歌詞',
      surfaceFill: '表面填色',
      ...
      custom: '自訂',
      opacity: '背景透明度',
      permissionHint: '請允許 Zephyrus 顯示在其他應用程式上層',
      installed: '已安裝',
      installFailed: '字型安裝失敗'
    },
    hideLyrics: '隱藏歌詞',
    hidePlayBar: '隱藏播放列',
    hideMiniPlayBar: '隱藏迷你播放列',
    alwaysShowPlayerControls: '始終顯示播放控制項',
  ...
  keepAlive: {
    ...
    audioFocus: '背景保活',
    audioFocusDesc: '保持媒體音訊焦點並避免可混音事件降音量；通話與系統高優先級音訊仍會暫停',
