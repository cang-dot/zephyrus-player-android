export default {
  ...
  about: {
    ...
    website: '官方网站',
    websiteDesc: '查看 Zephyrus Player 产品介绍、下载与文档',
    visitWebsite: '打开官网',
    author: '作者',
  ...
  onboarding: {
    ...
    continue: '继续',
    startSetup: '开始设置',
    startExperience: '直接开始体验',
    welcomeTitle: '欢迎使用 Zephyrus',
    welcomeSubtitle: '只需一分钟，完成专属你的播放器设置',
    featureSearch: '多平台搜索，点击即听',
    featureStyles: '9 种播放器样式与逐字歌词',
    featureLocal: '支持导入本地音乐',
    languageTitle: '选择语言',
    languageDesc: '可随时在设置中更改',
    themeTitle: '选择外观',
    ...
    themeDark: '深色',
    folderTitle: '导入本地音乐',
    folderDesc: '选择存放音乐的文件夹，自动扫描本地歌曲',
    folderPick: '选择文件夹',
    folderPickMore: '再选一个文件夹',
    folderPicking: '等待选择…',
    folderDone: '已添加 {n} 个文件夹',
    lyricTitle: '状态栏歌词',
    lyricDesc: '在其他应用上方悬浮显示当前播放歌词',
    lyricEnable: '开启并授权',
    lyricGranted: '已开启状态栏歌词',
    lyricNotGranted: '未完成授权，可稍后在设置中开启',
    lyricRetry: '重新授权',
    accountTitle: '登录音乐账号',
    accountDesc: '登录网易云、QQ 音乐等账号，使用你的歌单与收藏',
    accountDone: '登录成功，可随时在「我的」页管理账号',
    searchTitle: '搜索一首你喜欢的歌',
    searchDesc: '点击播放搜索结果，播放器会根据封面取色，随后即可在设置面板挑选播放器样式',
    searchPlaceholder: '歌曲名或歌手名',
    searchExample1: '晴天',
    searchExample2: '告白气球',
    searchExample3: '孤勇者',
    searchClear: '清空',
    searchRetry: '重试',
    searchEmpty: '没有找到相关歌曲',
    searchError: '搜索失败，请检查网络',
    stylePickTitle: '挑选你的播放器样式',
    stylePickDesc: '上方实时预览播放器效果，点击样式立即切换，可继续自定义细节',
    stylePickHint: '提示：滚动歌词逐字跟随，效果在播放时最佳',
    changeSong: '换首歌试试',
  ...
  lyricSettings: {
    ...
    centerDisplay: '居中显示',
    alignment: '歌词对齐',
    alignmentDescription: '调整滚动歌词的水平对齐方式',
    alignmentLeft: '左对齐',
    ...
    scrollFont: '滚动歌词字体',
    scrollFontDescription: '仅作用于全屏滚动歌词页',
    scrollFontDefault: '默认',
    scrollFontWeight: '滚动歌词字重',
    scrollFontSize: '滚动歌词大小',
    scrollFontSizeAuto: '默认',
    ...
    statusBarLyricOptions: {
      enable: '启用悬浮歌词',
      enableDesc: '显示在其他应用上层',
      portrait: '竖屏',
      landscape: '横屏',
      wordByWord: '逐字显示',
      wordByWordDesc: '关闭时使用整句未唱文字色',
      capsuleWidth: '胶囊宽度',
      capsuleWidthDesc: '自适应歌词长度，或固定宽度滚动显示',
      widthFit: '跟随歌词',
      widthFixed: '固定滚动',
      fixedWidth: '固定宽度',
      font: '字体',
      fontDesc: '悬浮窗仅支持系统、TTF 与 OTF',
      systemFont: '系统字体',
      importedFont: '已导入字体',
      fontSize: '字号',
      fontWeight: '字重',
      importFont: '导入 TTF/OTF',
      sung: '已唱歌词',
      current: '当前分词',
      upcoming: '未唱歌词',
      surfaceFill: '表面填充',
      ...
      custom: '自定义',
      opacity: '背景透明度',
      permissionHint: '请允许 Zephyrus 显示在其他应用上层',
      installed: '已安装',
      installFailed: '字体安装失败'
    },
    hideLyrics: '隐藏歌词',
    hidePlayBar: '隐藏播放栏',
    hideMiniPlayBar: '隐藏迷你播放栏',
    alwaysShowPlayerControls: '始终显示播放控件',
  ...
  keepAlive: {
    ...
    audioFocus: '后台保活',
    audioFocusDesc: '保持媒体音频焦点并避免可混音事件降音量；通话和系统高优先级音频仍会暂停',
