export default {
  ...
  update: {
    ...
    nowUpdate: '立即更新',
    installNow: '立即安装',
    backgroundStart: '已开始后台下载更新包',
    backgroundDone: '更新包下载完成，可在 设置→关于 中立即安装',
  ...
  homeV2: {
    roamTitle: '歌曲漫游',
    roamSubtitle: '从喜欢的歌开始',
    cloudTitle: 'Zephyrus云',
    cloudSubtitle: '开发者收集的封禁/付费歌曲',
    cloudEmpty: '云库整理中',
    openCloud: '打开云库',
    playAria: '开始心动模式',
    pauseAria: '暂停',
    recommendTitle: '根据你喜爱的歌曲推荐',
    loginHint: '登录后查看每日推荐',
    forYouTitle: '为你推荐',
    badge: '精选歌单',
    tagLossless: '无损',
