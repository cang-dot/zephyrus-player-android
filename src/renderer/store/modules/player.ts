...
export const usePlayerStore = defineStore('player', () => {
  ...
  return {
    ...
    setFullLyricsVisible: playerCore.setFullLyricsVisible,
    setFullCommentsVisible: playerCore.setFullCommentsVisible,
    setPlayerSettingsVisible: playerCore.setPlayerSettingsVisible,
    ...
    markUserPlayIntent: playerCore.markUserPlayIntent,
