    ...
    >
      ...
      >
        ...
        <div class="content-info p-4 md:p-6">
          <h3
            class="content-name line-clamp-2 text-base md:text-lg font-bold leading-tight text-neutral-800 dark:text-neutral-100 transition-colors duration-200 group-hover:text-[var(--accent-color)] dark:group-hover:text-white"
          >
            {{ content.name }}
          </h3>
          <p
