<template>
  <div>
    <setting-section :title="t('settings.sections.advanced')">
      ...
      <button v-else type="button" class="advanced-toggle" @click="expanded = true">
        <i class="ri-settings-4-line"></i>
        <span>显示进阶选项（动画、口令解锁、Cookie 等）</span>
