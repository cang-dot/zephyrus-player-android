        ...
        <template v-else>
          ...
          <section v-else class="page-padding-x">
            ...
            >
              ...
              >
                ...
                <div class="relative mx-auto w-fit">
                  ...
                  >
                    <i class="ri-verified-badge-fill text-[var(--accent-color)] text-sm" />
                  </div>
                </div>
                ...
                <div class="mt-3 text-center">
                  <h3
                    class="text-sm font-semibold text-neutral-800 dark:text-neutral-100 group-hover:text-[var(--accent-color)] transition-colors truncate px-1"
                  >
                    {{ item.nickname }}
                  </h3>
            ...
            <div v-if="followerListLoading" class="flex items-center justify-center gap-2 py-8">
              <div
                class="w-5 h-5 border-2 border-t-[var(--accent-color)] rounded-full animate-spin"
              />
