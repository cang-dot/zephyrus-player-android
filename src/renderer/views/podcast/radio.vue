                  ...
                  <div class="radio-info flex-1 text-center md:text-left">
                    ...
                    >
                      <div class="stat-item flex items-center gap-2">
                        <i class="ri-user-follow-line text-[var(--accent-color)] text-lg" />
                      ...
                      <div class="stat-item flex items-center gap-2">
                        <i class="ri-play-list-2-line text-[var(--accent-color)] text-lg" />
                        <span class="text-sm font-medium text-neutral-600 dark:text-neutral-300">
                          <span class="font-bold text-neutral-900 dark:text-white">{{
                  ...
                  <button
                    ...
                    :class="
                      isSubscribed
                        ...
                        : 'bg-[var(--accent-color)]/10 dark:bg-[var(--accent-color)]/20 text-[var(--accent-color)] border border-[var(--accent-color)]/20'
                    "
...
const loadRadioDetail = async () => {
  try {
    ...
    console.error('鑾峰彇鐢靛彴璇︽儏澶辫触:', error);
