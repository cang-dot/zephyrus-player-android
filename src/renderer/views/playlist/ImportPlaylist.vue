      ...
      <div class="max-w-5xl mx-auto w-full flex items-end justify-between">
        <div>
          <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-2 flex items-center gap-3">
            <div
              class="w-10 h-10 rounded-xl bg-[var(--accent-color)]/10 flex items-center justify-center text-[var(--accent-color)]"
            >
      ...
      <div class="w-full max-w-5xl mx-auto p-6 pb-24">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div class="lg:col-span-2 space-y-6">
            <div
              class="bg-white dark:bg-neutral-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-d-lg dark:shadow-none overflow-hidden p-1 transition-all duration-300"
            >
              <!-- 閾炬帴瀵煎叆鍐呭 -->
                ...
                <div class="space-y-4">
                  <div v-for="(link, index) in linkInputs" :key="index" class="group relative">
                    <input
                      ...
                      class="w-full bg-gray-50 dark:bg-white/5 border-2 border-transparent focus:border-[var(--accent-color)]/50 focus:bg-white dark:focus:bg-black rounded-2xl px-5 py-4 outline-none transition-all duration-300 text-gray-900 dark:text-white placeholder-gray-400"
                    />
                    <button
                  ...
                  <button
                    class="w-full py-3 rounded-2xl border-2 border-dashed border-gray-200 dark:border-gray-700 text-gray-500 hover:text-[var(--accent-color)] hover:border-[var(--accent-color)]/50 hover:bg-[var(--accent-color)]/5 transition-all duration-300 flex items-center justify-center gap-2 font-medium"
                    @click="addLinkRow"
                  >
              ...
              <div v-if="currentTab === 'text'" class="p-6 space-y-6 animate-fade-in">
                <textarea
                  ...
                  rows="12"
                  class="w-full bg-gray-50 dark:bg-white/5 border-2 border-transparent focus:border-[var(--accent-color)]/50 focus:bg-white dark:focus:bg-black rounded-2xl px-5 py-4 outline-none transition-all duration-300 text-gray-900 dark:text-white placeholder-gray-400 font-mono text-sm resize-none"
                ></textarea>
                ...
                <div class="space-y-3">
                  ...
                  >
                    ...
                    <input
                      ...
                      class="flex-1 bg-gray-50 dark:bg-white/5 border-transparent focus:border-[var(--accent-color)]/50 rounded-xl px-4 py-2.5 outline-none text-sm transition-all border-2"
                    />
                    <input
                      v-model="item.artist"
                  ...
                  <button
                    class="ml-9 px-4 py-2 rounded-xl text-sm font-medium text-[var(--accent-color)] hover:bg-[var(--accent-color)]/10 transition-colors flex items-center gap-1"
          ...
          <div class="space-y-6">
            <!-- 选项卡片 -->
            <div
              class="bg-white dark:bg-neutral-900 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-d-lg dark:shadow-none p-6"
            >
              <h3 class="font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                <i class="ri-settings-4-line text-[var(--accent-color)]"></i>
              ...
              <div class="space-y-4">
                ...
                <div
                  ...
                  :class="
                    importToStarPlaylist
                      ? 'bg-[var(--accent-color)]/5 border-[var(--accent-color)]/50'
                ...
                >
                  <div class="flex items-center gap-3">
                    <div
                      ...
                      :class="importToStarPlaylist ? 'text-[var(--accent-color)]' : 'text-gray-400'"
                    >
                ...
                >
                  ...
                  <input
                    ...
                    class="w-full bg-gray-50 dark:bg-white/5 border-2 border-transparent focus:border-[var(--accent-color)]/50 rounded-2xl pl-11 pr-4 py-3.5 outline-none transition-all text-sm text-gray-900 dark:text-white"
                  />
                </div>
              </div>
