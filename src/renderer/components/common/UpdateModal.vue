    ...
    <div class="p-6 pb-4">
      <div class="mb-6 flex items-center">
        ...
        <div class="min-w-0 flex-1">
          ...
          <div class="flex items-center gap-2">
            ...
            <span
              v-if="showNewBadge"
              class="inline-flex items-center rounded-full bg-[var(--accent-color)]/10 px-2.5 py-0.5 text-xs font-semibold text-[var(--accent-color)] dark:bg-[var(--accent-color)]/20"
            >
              NEW
            </span>
          </div>
      ...
      >
        <div class="mb-2.5 flex items-center justify-between">
          ...
          <span class="text-sm font-bold text-[var(--accent-color)]">{{ progressPercent }}%</span>
        </div>
        <div
      ...
      <div class="flex gap-3" :class="{ 'mt-6': !showProgressCard }">
        ...
        <button
          class="flex-1 rounded-xl bg-[var(--accent-color)] py-2.5 text-sm font-semibold text-white transition-all duration-200 hover:scale-[1.02] hover:bg-[var(--accent-color)]/90 active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
