<template>
  ...
  >
    ...
    >
      ...
      >
        <n-spin size="large" stroke="var(--accent-color)" />
      </div>
      ...
      >
        <n-button
          ...
          circle
          size="large"
          class="!text-white hover:!text-[var(--accent-color)] scale-150"
        >
          <template #icon>
          ...
          <div class="flex items-center gap-2 md:gap-4">
            ...
            <template v-else>
              <n-button
                quaternary
                circle
                class="!text-white hover:!text-[var(--accent-color)]"
                @click="handlePrev"
      ...
      >
        ...
        >
          <n-icon size="32" class="text-[var(--accent-color)]">
...
.mv-slider {
  ...
  --n-fill-color: var(--accent-color) !important;
  --n-fill-color-hover: var(--accent-color-light) !important;
