...
var q_4 = { class: "folia-partita-root w-full h_10-full flex items-center justify-center overflow-hidden pointer-events-none select-none" }, G = { class: "relative z-10 w-full max-w-6xl h_10-[70vh] flex gap-4 items-center justify-center p-8" }, J = {
  __name: "PartitaTheme",
  props: {
  ...
  setup(S) {
var m_3 = S, u_9 = P(m_3, m_3.settings), L_3 = t_9(() => u_9.nowTime.value), __3 = t_9(() => u_9.nowIndex.value), v = t_9(() => u_9.lrcArray.value), j = t_9(() => v.value.map((e_53) => e_53.startTime ?? 0)), z = t_9(() => u_9.getCoverColor()), f = t_9(() => z.value.primary || "#ffffff"), p = t_9(() => K(f.value, 0.5)), y_2 = t_9(() => u_9.getClimaxState().isInClimax ? "#ff6b6b" : f.value), h_10 = t_9(() => H(v.value, j.value)), n_27 = t_9(() => {
var e_53 = __3.value;
      return e_53 < 0 || e_53 >= h_10.value.length ? null : h_10.value[e_53];
    }), F_3 = t_9(() => n_27.value?.startTime ?? 0), x_4 = t_9(() => {
var e_53 = n_27.value;
      if (!e_53) return [];
var s_43 = U(e_53, { semantic: !0, sticky: !0 });
      return $(s_43);
    }), g_5 = t_9(() => {
var e_53 = x_4.value;
      if (e_53.length === 0) return [];
var s_43 = Math.max(1, Math.ceil(e_53.length / E_3.value)), a_24 = [];
      for (let r_42 = 0; r_42 < e_53.length; r_42 += s_43) {
var l_27 = e_53.slice(r_42, r_42 + s_43);
        a_24.push({
          words: l_27,
          offset: (a_24.length % 2 === 0 ? -1 : 1) * 10 * (a_24.length + 1),
          wordIndex: r_42
        });
      }
      return a_24;
    ...
    V(L_3, (e_53) => {
      if (!n_27.value) return;
var s_43 = n_27.value.renderHints ?? O(n_27.value.startTime, n_27.value.endTime), a_24 = s_43.wordRevealMode === "instant" ? 0.03 : s_43.wordRevealMode === "fast" ? 0.08 : 0.15, r_42 = {};
      x_4.value.forEach((l_27, c_23) => {
        e_53 >= l_27.startTime - a_24 && e_53 <= l_27.endTime ? r_42[c_23] = "active" : e_53 > l_27.endTime ? r_42[c_23] = "passed" : r_42[c_23] = "waiting";
      }), w.value = r_42;
    }, { flush: "post" });
    function W(e_53) {
      return w.value[e_53] || "waiting";
    }
    function B(e_53, s_43) {
var a_24 = W(s_43);
      return a_24 === "waiting" ? {
        opacity: "0.3",
        color: f.value,
...
var E_3 = t_9(() => u_9.getConfigValue("foliaPartitaChunks") ?? 3), A = t_9(() => u_9.getConfigValue("foliaShowTranslation") ?? !0), I = k(!0);
    return (e_53, s_43) => (i_24(), o_29("div", q_4, [
      M_6("div", G, [
        Y(N, {
          name: "folia-fade",
          mode: "out-in"
          ...
          default: D(() => [
            I.value && g_5.value.length > 0 ? (i_24(), o_29("div", {
              key: F_3.value,
              class: "flex gap-6 h_10-full items-center justify-center flex-wrap"
            }, [
              (i_24(!0), o_29(b, null, T_8(g_5.value, (a_24, r_42) => (i_24(), o_29("div", {
                key: r_42,
                class: "flex flex-wrap justify-center gap-x_4-2 gap-y_2-1",
                style: d({
                  transform: `translateY(${a_24.offset}px)`,
                  transition: "transform 0.5s ease"
                })
              }, [
                (i_24(!0), o_29(b, null, T_8(a_24.words, (l_27, c_23) => (i_24(), o_29("span", {
                  key: c_23,
                  class: "font-bold inline-block transition-all duration-500",
                  style: d(B(l_27, a_24.wordIndex + c_23))
                }, C(l_27.text), 5))), 128))
              ], 4))), 128))
            ])) : (i_24(), o_29("div", {
              key: "empty",
      ...
      n_27.value?.translation && A.value ? (i_24(), o_29("div", {
        key: 0,
      ...
      }, C(n_27.value.translation), 5)) : R_3("", !0)
    ]));
  }
};
J.settings = [
