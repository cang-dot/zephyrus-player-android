...
var q=function q(t_2, e_2, n_2, r_2, s_2, i_2) {
var l_2 = Jt.get(t_2);
  if (!l_2) {
    pt++;
    return;
...
var c_2 = l_2 ? Number(n_2) < e_2.length : zt(e_2, n_2), o_2 = Reflect.set(
    ...
    return e_2 === /* @__PURE__ */ _(s_2) && o_2 && (c_2 ? j(r_2, i_2) && q(e_2, "set", n_2, r_2) : q(e_2, "add", n_2, r_2)), o_2;
  }
  deleteProperty(e_2, n_2) {
var r_2 = zt(e_2, n_2);
    e_2[n_2];
var s_2 = Reflect.deleteProperty(e_2, n_2);
    return s_2 && r_2 && q(e_2, "delete", n_2, void 0), s_2;
  }
  has(e_2, n_2) {
...
var i_2 = /* @__PURE__ */ _(this), l_2 = vt(i_2), c_2 = /* @__PURE__ */ _(s_2), o_2 = !e_2 && !/* @__PURE__ */ L(s_2) && !/* @__PURE__ */ U(s_2) ? c_2 : s_2;
        return l_2.has.call(i_2, o_2) || j(s_2, o_2) && l_2.has.call(i_2, s_2) || j(c_2, o_2) && l_2.has.call(i_2, c_2) || (i_2.add(o_2), q(i_2, "add", o_2, o_2)), this;
      },
      set(s_2, i_2) {
...
var a_2 = o_2.call(l_2, s_2);
        return l_2.set(s_2, i_2), f_2 ? j(i_2, a_2) && q(l_2, "set", s_2, i_2) : q(l_2, "add", s_2, i_2), this;
      },
      delete(s_2) {
...
var f_2 = i_2.delete(s_2);
        return o_2 && q(i_2, "delete", s_2, void 0), f_2;
      },
      clear() {
...
var ae_2 = { class: "folia-cadenza-root w-full h_5-full overflow-hidden pointer-events-none select-none" }, ne = { class: "absolute inset-0 w-full h_5-full" }, oe = {
  ...
  setup(q) {
var T_4 = q, l = U(T_4, T_4.settings), P = a_12(() => l.nowTime.value), N = a_12(() => l.nowIndex.value), $ = a_12(() => l.lrcArray.value), O = a_12(() => $.value.map((e_26) => e_26.startTime ?? 0)), W = a_12(() => l.getCoverColor()), M = a_12(() => W.value.primary || "#ffffff"), f = a_12(() => l.getClimaxState().isInClimax ? "#ff6b6b" : M.value), S = a_12(() => ee($.value, O.value)), E = a_12(() => {
var e_26 = N.value;
      return e_26 < 0 || e_26 >= S.value.length ? null : S.value[e_26];
    }), _ = L(null);
var r_20 = 0;
var h_5 = L([]), V = a_12(() => l.getConfigValue("foliaCadenzaRadius") ?? 0.25), j = a_12(() => l.getConfigValue("foliaGlowIntensity") ?? 1);
    function i() {
var e_26 = _.value;
      if (!e_26) {
        r_20 = requestAnimationFrame(i);
        return;
      }
var t_5 = e_26.getContext("2d");
      if (!t_5) {
        r_20 = requestAnimationFrame(i);
        return;
      }
var n_14 = window.devicePixelRatio || 1, s = e_26.clientWidth, c = e_26.clientHeight;
      e_26.width !== s * n_14 && (e_26.width = s * n_14), e_26.height !== c * n_14 && (e_26.height = c * n_14), t_5.setTransform(n_14, 0, 0, n_14, 0, 0), t_5.clearRect(0, 0, s, c);
var y = E.value;
      if (!y) {
        h_5.value = [], r_20 = requestAnimationFrame(i);
        return;
      }
var x_2 = P.value, u = Math.min(48, Math.max(20, s * 0.04));
      t_5.font = `700 ${u}px "Noto Sans SC", sans-serif`;
var v_2 = [], w = y.words.length, D = s / 2, G = c / 2, z = Math.min(s, c) * V.value, g = j.value;
      for (let m = 0; m < w; m++) {
var o_14 = y.words[m], k = -Math.PI / 2 + (w > 1 ? m / w * Math.PI * 2 : 0), C = D + Math.cos(k) * z, F = G + Math.sin(k) * z, I = Math.max(0, Math.min(1, (x_2 - o_14.startTime) / Math.max(o_14.endTime - o_14.startTime, 0.3))), d = Math.min(1, I * 2), p = 0.5 + I * 0.5, B = x_2 >= o_14.startTime && x_2 <= o_14.endTime;
        if (B) {
var H_2 = u * 1.5 * g;
          t_5.shadowColor = f.value, t_5.shadowBlur = H_2, t_5.fillStyle = f.value, t_5.globalAlpha = Math.min(1, 0.6 + d * 0.4), t_5.fillText(o_14.text, C - t_5.measureText(o_14.text).width / 2, F + u / 3), t_5.shadowBlur = 0, t_5.globalAlpha = 1;
        }
        B ? v_2.push({
          text: o_14.text,
          style: {
            ...
            fontSize: `${u * p}px`,
            color: "transparent",
            textShadow: `0 0 ${12 * g}px ${f.value}, 0 0 ${24 * g}px ${f.value}`,
      ...
      h_5.value = v_2, r_20 = requestAnimationFrame(i);
    }
    return X(() => {
      r_20 = requestAnimationFrame(i);
    }), Y(() => {
      cancelAnimationFrame(r_20);
    }), (e_26, t_5) => (b(), A("div", ae_2, [
      R("canvas", {
        ref_key: "canvasRef",
        ref: _,
        class: "absolute inset-0 w-full h_5-full"
      }, null, 512),
      R("div", ne, [
        (b(!0), A(J, null, K(h_5.value, (n_14, s) => (b(), A("span", {
          key: s,
