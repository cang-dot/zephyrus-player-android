...
var a_23=function a_23(t_9, e_53) {
  if (t_9.startsWith("#")) {
var r_41 = parseInt(t_9.slice(1, 3), 16), s_43 = parseInt(t_9.slice(3, 5), 16), n_27 = parseInt(t_9.slice(5, 7), 16);
    return `rgba(${r_41},${s_43},${n_27},${e_53})`;
  }
  return t_9.startsWith("rgb(") ? t_9.replace("rgb(", "rgba(").replace(")", `,${e_53})`) : t_9;
}
__sh_colorMix_CCs_cg1y_js.c=a_23;
var X = { class: "folia-tilt-root w-full h-full flex items-center justify-center overflow-hidden pointer-events-none select-none" }, Z = { class: "relative z-10 w-full h-[70vh] flex flex-col items-center justify-center p-8 gap-4" }, ee = {
  __name: "TiltTheme",
  props: {
  ...
  setup(k) {
var x_4 = k, c = Y(x_4, x_4.settings), _ = l(() => c.nowTime.value), M = l(() => c.nowIndex.value), C = l(() => c.lrcArray.value), z = l(() => C.value.map((e_53) => e_53.startTime ?? 0)), A = l(() => c.getCoverColor()), m = l(() => A.value.primary || "#ffffff"), w = l(() => U(m.value, 0.5)), S = l(() => Q(C.value, z.value)), f = l(() => {
var e_53 = M.value;
      return e_53 < 0 || e_53 >= S.value.length ? null : S.value[e_53];
    }), j = l(() => f.value?.startTime ?? 0), D = l(() => c.getConfigValue("foliaTiltSplitCount") ?? 2), I = l(() => c.getConfigValue("foliaShowTranslation") ?? !0), d = g(0), L = g(0), p = l(() => {
var e_53 = f.value;
      if (!e_53 || !e_53.fullText) return [];
var a_23 = e_53.fullText, t_9 = [], o = D.value;
      return N(a_23, o).forEach((s_43, u) => {
        t_9.push({
          chars: Array.from(s_43),
          isTilt: u === o - 1
        });
      }), t_9;
    });
    function N(e_53, a_23) {
      if (a_23 <= 1 || e_53.length < 6) return [e_53];
var t_9 = Math.floor(e_53.length / 2), o = [
        { pos: h(e_53, t_9 - 2), score: 0 },
        { pos: h(e_53, t_9), score: 1 },
        { pos: h(e_53, t_9 + 2), score: 2 }
      ];
      o.sort((s_43, u) => Math.abs(s_43.pos - t_9) - Math.abs(u.pos - t_9));
var n_27 = o[0].pos;
      return [e_53.slice(0, n_27).trim(), e_53.slice(n_27).trim()];
    }
    function h(e_53, a_23) {
var t_9 = [",", ".", "，", "、", "。", "；", "：", "!", "?", "！", "？", " ", "　"];
      for (const o of t_9) {
var n_27 = e_53.indexOf(o, Math.max(0, a_23));
        if (n_27 > 0 && n_27 < e_53.length - 1) return n_27 + 1;
var s_43 = e_53.lastIndexOf(o, Math.min(e_53.length - 1, a_23));
        if (s_43 > 0) return s_43 + 1;
      }
      return Math.max(1, a_23);
    }
    $(_, (e_53) => {
var a_23 = f.value;
      if (!a_23) {
...
var t_9 = Math.max(a_23.endTime - a_23.startTime, 0.5), o = Math.max(0, e_53 - a_23.startTime);
      d.value = Math.min(o / t_9, 1);
    });
    function V(e_53, a_23) {
var t_9 = p.value.reduce((y, T) => y + T.chars.length, 0);
      if (t_9 === 0) return { opacity: "0" };
var n_27 = (p.value.slice(0, e_53).reduce((y, T) => y + T.chars.length, 0) + a_23) / t_9, s_43 = d.value >= n_27, u = n_27 * 0.5;
      return s_43 ? {
        opacity: "1",
        transform: "translateY(0)",
        color: e_53 === 1 ? O.value : m.value,
        transitionDelay: `${u}s_43`
      } : { opacity: "0", transform: "translateY(8px)", transitionDelay: `${u}s_43` };
    }
var O = l(() => c.getClimaxState().isInClimax ? "#ff6b6b" : m.value), E = g(!0), P = l(() => !I.value);
    return K(() => {
      L.value = Date.now();
    }), (e_53, a_23) => (i(), r_41("div", X, [
      R("div", Z, [
        q(W, {
          name: "folia-fade",
          mode: "out-in"
          ...
          default: G(() => [
            E.value && p.value.length > 0 ? (i(), r_41("div", {
              key: j.value,
              class: "flex flex-col items-center gap-3"
            }, [
              (i(!0), r_41(F, null, B(p.value, (t_9, o) => (i(), r_41("div", {
                key: o,
                class: J(["flex flex-wrap justify-center gap-[0.15em]", t_9.isTilt ? "italic font-light" : "font-normal"]),
                style: v({
                  fontSize: t_9.isTilt ? "clamp(2.5rem, 7vw, 5rem)" : "clamp(1.5rem, 4vw, 3rem)",
                  letterSpacing: t_9.isTilt ? "0.15em" : "0.08em",
                  color: m.value
                })
              }, [
                (i(!0), r_41(F, null, B(t_9.chars, (n_27, s_43) => (i(), r_41("span", {
                  key: s_43,
              ...
              style: v({ color: w.value })
            }, " 聆听音乐... ", 4))
          ]),
          _: 1
        })
      ]),
      f.value?.translation && !P.value ? (i(), r_41("div", {
        key: 0,
        class: "absolute bottom-16 left-1/2 -translate-x_4-1/2 text-center z-20",
        style: v({ color: w.value, fontSize: "clamp(1rem, 2.2vw, 1.25rem)", maxWidth: "80vw" })
      }, b(f.value.translation), 5)) : H("", !0)
    ]));
  }
};
ee.settings = [
